...
class TrainerPPO():
        ...
        # Trains a model using PPO for the specificed amount of iterations where each iteration is 10.000 time steps. Saves models incrementally at every 10.000 time step.
        ...
        # Continues training using the provided model for the inital policy for the specificed amount of iterations where each iteration is 10.000 time steps. Saves models incrementally at every 10.000 time step.
        ...
        def _make_names(self):
            model_name = f'PPO_{self.obs_space}_{date.today()}'

            # Check for unique save path
            unique_name = False
            i = 0
            while not unique_name:
                save_path = f'PPO_models/{model_name}_{i}'
